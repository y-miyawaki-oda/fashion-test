...
<header>
	<div class="wrap">
		<h1 class="logo"><a href="<?php echo esc_url(home_url('/')); ?>" class="fade"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/img/opencampus/logo_pc.png" alt="織田ファッション専門学校" class="switch"></a></h1>
		<nav class="gnavi">
			<ul class="main">
				<li class="pc1260">
	...
	<div class="bg_dot">
		...
		<section id="about" class="sec_about is_anime fadein">
			<div class="wrap w1200">
				<div class="head">
					<div class="img">
						<div class="img_cross cross01"><img src="/new/wp-content/uploads/2021/03/stevndv15431_250_250.jpg" alt=""></div>
						<div class="img_cross cross02"><img src="/new/wp-content/uploads/2021/03/stevndv15621_250_250.jpg" alt=""></div>
					</div>
					<h2 class="ttl">
						<span class="mark">明日からのコーデが楽しくなる！</span><br>
						織田ファッションの<br><span class="color">オープンキャンパス！</span>
					</h2>
				</div>
				<div class="detail">
					<h3 class="box_ttl">織田ファッションの<br class="sp br_tab"><span class="big">オープンキャンパスでは...</span></h3>
					<ul class="list">
						<li>
							<div class="img"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/img/opencampus/about_icon01.png" alt=""></div>
							<h4 class="txt">職業を<br class="pc"><span class="big">体験できる</span></h4>
						</li>
						<li>
				...
				<div class="menu">
					<h3 class="box_ttl">ファッション分野の<br><span class="big">いろんな職業や役割を体験</span><br class="sp br_tab">できるメニューを揃えました</h3>
					<div class="grid">
						<div class="box box_red">
							<div class="top">
								...
								<h4 class="ttl">ファッション<br class="sp">デザイン<br>&<br>ファッション<br class="sp br_tab">テクニカルコース</h4>
							</div>
						...
						<div class="box box_blue">
							<div class="top">
								...
								<h4 class="ttl">スタイリスト<br>&<br>ファッション<br class="sp br_tab">ビジネスコース</h4>
							</div>
							<p class="ttl_osusume"><span class="mark">こんな人におすすめ！</span></p>
							<div class="center">
								<ul class="check">
									<li>販売員になりたい！</li>
									<li>スタイリストについて知りたい！ </li>
									<li>ブランド経営に興味がある...！ </li>
								</ul>
							</div>
						</div>
	...
	<div class="bg_green">
			...
			<?php
				...
				foreach($calendar as $key => $val) {
					...
					if($val["class"] !== "prev" && $val["class"] !== "next") {
						...
						if($oc_arr[$date_txt]["design_technical"] || $oc_arr[$date_txt]["stylist_business"]) {
							$table .= '<ul class="icon">';
							if($oc_arr[$date_txt]["design_technical"]) {
								$table .= '<li><a href="#oc'.$oc_arr[$date_txt]["design_technical"].'"><img src="'.esc_url(get_template_directory_uri()).'/img/opencampus/schedule_icon01.png" alt=""></a></li>';
							}
							if($oc_arr[$date_txt]["stylist_business"]) {
								$table .= '<li><a href="#oc'.$oc_arr[$date_txt]["stylist_business"].'"><img src="'.esc_url(get_template_directory_uri()).'/img/index/oc_icon_stylist_business.png" alt=""></a></li>';
							}
							$table .= '</ul>';
						}
					}
		...
		?>
					...
					<div class="course grid2">
						<div class="item">
							<p class="icon"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/img/opencampus/schedule_icon01.png" alt=""></p>
							<p class="txt">ファッションデザイン&amp;<br class="sp br_tab">テクニカルコース</p>
						</div>
						<div class="item">
							<p class="icon"><img src="<?php echo esc_url(get_template_directory_uri()); ?>/img/opencampus/schedule_icon02.png" alt=""></p>
							<p class="txt">スタイリスト&amp;<br class="sp br_tab">ファッションビジネスコース</p>
						</div>
					</div>
				</div>
				<div class="detail">
		...
		<?php if($posts): ?>
			...
			<?php foreach($posts as $key => $post): setup_postdata($post); ?>
				<?php
					...
					if($cat === "design_technical") {
						$cat_class = 'red';
						$cat_icon = 'schedule_icon03';
						$cat_txt = 'デザイナーやパタンナー、<br class="sp br_tab">縫製に興味がある人向け！！';
					}
					elseif($cat === "stylist_business") {
						$cat_class = 'blue';
						$cat_icon = 'schedule_icon04';
						$cat_txt = '販売員やスタイリストに <br class="sp br_tab">興味がある人向け';
					}
				?>
